...
object AncsConstants {
    ...
    // ----------------------------------------------------------------------
    // Health sync service (watch acts as GATT peripheral; iPhone is central)
    // ----------------------------------------------------------------------
    val HEALTH_SERVICE_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E2F")

    val HEART_RATE_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E30")
    val SPO2_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E31")
    val STEPS_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E32")
    val CALORIES_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E33")
    val DISTANCE_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E34")
    val SLEEP_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E35")
    val EXERCISE_UUID: UUID = UUID.fromString("B2C4E6F8-1A2B-3C4D-5E6F-7A8B9C0D1E36")

    // Advertised local name for the health GATT server
    const val HEALTH_ADVERTISE_NAME = "SwatchHealth"
}
